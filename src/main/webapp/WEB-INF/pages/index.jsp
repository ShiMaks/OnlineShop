          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="/shop/cart/show">Contact</a></li>
              </ul>
            </div>
          </div>
        </div>
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm category-menu">
                    <c:forEach items="${categories}" var="category">
                      <li class="nav-item"><a href="<c:url value="category/${category.id}" />" class="nav-link d-flex align-items-center justify-content-between"><span>${category.name}</span><span class="badge badge-secondary"></span></a>
                      </li>
                    </c:forEach>
              ...
              <div class="row products products-big">
                <c:forEach items="${productsIndex}" var="product">
                  <div class="col-lg-4 col-md-6">
                    <div class="product">
                      <div class="image"><a href="/shop/category/product/infproduct/${product.id}"><img src="${product.getPicture()}" alt="" class="img-fluid image1"></a></div>
                      <div class="text">
                        <h3 class="h5"><a href="/shop/category/product/infproduct/${product.id}">${product.name}</a></h3>
