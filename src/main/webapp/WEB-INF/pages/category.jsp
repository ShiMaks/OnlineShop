                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm category-menu">
                    <c:forEach items="" var="category">
                      <li class="nav-item"><a href="/shop/category/product/" class="nav-link d-flex align-items-center justify-content-between"><span>${category.name}  </span><span class="badge badge-secondary"></span></a>
                      </li>
                    </c:forEach>
